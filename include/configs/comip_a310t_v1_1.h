...
#define CONFIG_COMIP_A310T_V1_1 	1
...
#define CONFIG_FB_MEMORY_SIZE		(0x00200000UL)
...
#define CONFIG_CHARGER_POWER_OFF_LEVEL		(3600) /* mv */
#define CONFIG_NO_CHARGER_POWER_OFF_LEVEL	(3600) /* mv */
...
#define CONFIG_BOOTARGS_RECOVERY_RAMDISK	"initrd=0x07400000,2M "
...
#define CONFIG_COMIP_PARTITIONS		\
	...
	{0x200, 0x00022000, 0x00001000, CONFIG_PARTITION_RAMDISK_RECOVERY}, \
	{0x200, 0x00023000, 0x00003000, CONFIG_PARTITION_KERNEL_RECOVERY}, \
	{0x200, 0x00026800, 0x00000400, CONFIG_PARTITION_DDR}, \
