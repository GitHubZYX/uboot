...
#define CONFIG_COMIP_LC1860_ZEUS 	1

#define CONFIG_CURR_PRODUCT_NAME	"zeus"
...
#define CONFIG_BOOTARGS_RECOVERY_RAMDISK	"initrd=0x08800000,3M "
...
#define CONFIG_EMMC_SIZE		(7.4*1024*1024*2)
