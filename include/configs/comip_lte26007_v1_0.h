...
#define CONFIG_COMIP_LTE26007_V1_0 	1
...
#define CONFIG_MEMCTL0_CS1_SIZE	(0UL)			// max 1G (0x40000000UL)
#define CONFIG_MEMCTL1_CS0_SIZE	(0x20000000UL)		// max 1G (0x40000000UL)
...
#define CONFIG_COMIP_PARTITIONS		\
	{0x200, 0x00000000, 0x00000200, CONFIG_PARTITION_UBOOT}, \
	{0x200, 0x00000400, 0x00000400, CONFIG_PARTITION_LCBOOT}, \
	{0x200, 0x00000800, 0x00002000, CONFIG_PARTITION_FASTBOOT_LOGO}, \
	{0x200, 0x00002800, 0x00002000, CONFIG_PARTITION_LOGO}, \
	...
	{0x200, 0x00026000, 0x00000400, CONFIG_PARTITION_DDR}, \
	{0x200, 0x00027000, 0x00001000, CONFIG_PARTITION_MISC}, \
	{0x200, 0x00028000, 0x00040000, CONFIG_PARTITION_CACHE}, \
	{0x200, 0x00068000, 0x002c0000, CONFIG_PARTITION_SYSTEM}, \
