...
#define CONFIG_COMIP_M9206_V1_0 	1
...
#define CONFIG_MEMCTL0_CS0_SIZE	(0x20000000UL)		// max 1G (0x20000000UL)
#define CONFIG_MEMCTL0_CS1_SIZE	(0x00000000UL)		// max 1G (0x40000000UL)
...
#define CONFIG_CHARGER_BQ24296			1
...
#define CONFIG_COMIP_PARTITIONS		\
	...
	{0x200, 0x003B0000, 0x00350800, CONFIG_PARTITION_USERDATA},
