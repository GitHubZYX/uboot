...
//#define CONFIG_ENABLE_SECURE_VERIFY_FOR_BOOT   /* Enable rsa verify for kernel and ramdisk when boot*/
//#define CONFIG_ENABLE_SECURE_VERIFY_DEBUG
...
#define CONFIG_COMIP_K706_V1_0 	1



// ddr2
#define CONFIG_LPDDR2S4_4GB_X32_1066		1

#define CONFIG_MEMCTL0_CS0_SIZE	(0x10000000UL)		// max 1G (0x20000000UL)
#define CONFIG_MEMCTL0_CS1_SIZE	(0x10000000UL)		// max 1G (0x40000000UL)
...
#define CONFIG_DDR_BUS_CLK		520000000    /* Configure DDR bus clock. */
...
#define KEY_CODE_AMT3		(KEYPAD_VOL_DOWN)
...
#define BUCK2_VOUT_LEVEL_3			(10625) /* 0.1mv */

/* BUCK3 voltage(DVFS). */
#define BUCK3_VOUT_LEVEL_0			(7250)  /* 0.1mv */
#define BUCK3_VOUT_LEVEL_1			(8500) /* 0.1mv */
#define BUCK3_VOUT_LEVEL_2			(8750) /* 0.1mv */
#define BUCK3_VOUT_LEVEL_3			(9750) /* 0.1mv */

/* BUCK4 voltage(DVFS). */
#define BUCK4_VOUT_LEVEL_0			(11500) /* 0.1mv */
#define BUCK4_VOUT_LEVEL_1			(13500) /* 0.1mv */
...
#define CONFIG_BOOTARGS_RECOVERY_RAMDISK	"initrd=0x07400000,1M "
...
#define CONFIG_COMIP_PARTITIONS         \
	...
	{0x200, 0x00068000, 0x00148000, CONFIG_PARTITION_SYSTEM}, \
	{0x200, 0x001B0000, 0x00200000, CONFIG_PARTITION_UDISK}, \
	{0x200, 0x003B0000, 0x00B2F702, CONFIG_PARTITION_USERDATA},
