...
#define CONFIG_COMIP_SMART_V1_0 	1
...
#define CONFIG_RECOVERY_BOOTARGS               "console=ttyS3,115200 vmalloc=312M " CONFIG_BOOTARGS_RECOVERY_RAMDISK CONFIG_BOOTARGS_MEM "android "
