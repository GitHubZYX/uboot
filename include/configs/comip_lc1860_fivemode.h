...
#define CONFIG_COMIP_LC1860_EVB2 	1
 ...
 */
#define CONFIG_MODEM_MEMORY_SIZE	(120 * 1024 * 1024UL)
...
#define VOL_UP_KEYCODE		KEYPAD_GPIO_KEYCODE(74, 0)
#define VOL_DOWN_KEYCODE	KEYPAD_GPIO_KEYCODE(75, 0)
...
//#define CONFIG_CHARGER_NCP1851			1
...
#define CONFIG_BOOTARGS_RAMDISK		"initrd=0x08800000,1M "
#define CONFIG_BOOTARGS_RECOVERY_RAMDISK	"initrd=0x08800000,2M "
#define CONFIG_RAMDISK_LOADADDR		(0x08800000)
...
#define CONFIG_EMMC_SIZE		(7.51*1024*1024*2)
...
#define CONFIG_PART_UBOOT_LEN		0x00000100//128K
#define CONFIG_PART_GAP1_LEN			0x00000300//384K
#define CONFIG_PART_LCBOOT_LEN		0x00000400//512K
#define CONFIG_PART_LOGO_LEN			0x00004000//8M
...
#define CONFIG_PART_MODEM_ARM_LEN		0x0000D800//27M
#define CONFIG_PART_MODEM_DSP_LEN		0x0000C800//25M
...
#define CONFIG_PART_RAMDISK_RECOVERY_LEN	0x00000800//1M
...
#define CONFIG_PART_SYSTEM_LEN		0x00148000//656M
#define CONFIG_PART_UDISK_LEN		0x00200000//1G
...
#define CONFIG_PART_LOGO_START        	(CONFIG_PART_LCBOOT_START + CONFIG_PART_LCBOOT_LEN)
...
#define CONFIG_PART_UDISK_START       	(CONFIG_PART_SYSTEM_START + CONFIG_PART_SYSTEM_LEN)
#define CONFIG_PART_USERDATA_START   (CONFIG_PART_UDISK_START + CONFIG_PART_UDISK_LEN)
...
#define CONFIG_COMIP_PARTITIONS		\
	...
	{0x200, PART_START(UDISK), 	 PART_LEN(UDISK), 	PART_NAME(UDISK)}, 		\
