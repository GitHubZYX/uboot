...
#define CONFIG_CPU_LC1810	1

#define CONFIG_COMIP			1
#define CONFIG_COMIP_YL8150S_EVB 	1
#define CONFIG_8GBIT_DDR 		1

#define CONFIG_DDR_BUS_CLK		351000000	/* Configure DDR bus clock. */
#define CONFIG_A9_CLK			1196000000	/* Configure A9 clock. */

#define CONFIG_DDR_LP_ENABLE		0
#define CONFIG_WATCHDOG_ENABLE		1
#define CONFIG_WATCHDOG_DEBUG		1
...
#define VOL_UP_KEYCODE		KEYPAD_GPIO_KEYCODE(100, 0)
#define VOL_DOWN_KEYCODE	KEYPAD_GPIO_KEYCODE(101, 0)

#define KEY_CODE_RECOVERY	(KEYPAD_VOL_DOWN)
#define KEY_CODE_AMT1		(KEYPAD_VOL_UP)
#define KEY_CODE_AMT3		(KEYPAD_VOL_UP | KEYPAD_VOL_DOWN)

/*
 * PMIC Setting.
 */
#define CONFIG_COMIP_PMIC			1
#define CONFIG_PMIC_LC1100HT			1
#define CONFIG_LOW_VOLTAGE_CHARGING		0
#define CONFIG_CHARGER_POWER_OFF_LEVEL		(3200) /* mv */
...
*/
#define BUCK2_VOUT_SEL				(2)

/* Buck1 voltage(DVFS). */
#define BUCK1_VOUT_LEVEL_0			(900)  /* mv */
#define BUCK1_VOUT_LEVEL_1			(1200) /* mv */

/* BUCK2 voltage(DVFS). */
#define BUCK2_VOUT_LEVEL_0			(900)  /* mv */
#define BUCK2_VOUT_LEVEL_1			(1200) /* mv */
#define BUCK2_VOUT_LEVEL_2			(1250) /* mv */
#define BUCK2_VOUT_LEVEL_3			(1250) /* mv */
...
#define CONFIG_COMIP_PARTITIONS		\
	...
	{0x200, 0x00120000, 0x00600000, CONFIG_PARTITION_USERDATA},
...
#define CONFIG_KEY_CODE_FASTBOOT	(KEYPAD_VOL_UP | KEYPAD_VOL_DOWN)
