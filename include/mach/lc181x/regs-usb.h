...
#define USB_GNPTXSTS_NPTXQTOP_POS	(24)
#define USB_GNPTXSTS_NPTXQTOP_WID	(7)
#define USB_GNPTXSTS_NPTXQSPCAV_POS	(16)
#define USB_GNPTXSTS_NPTXQSPCAV_WID	(8)
#define USB_GNPTXSTS_NPTXFSPCAV_POS	(0)
#define USB_GNPTXSTS_NPTXFSPCAV_WID	(16)
...
/* register define for lc1810 usb-otg controller. :end */


#define CTL_USB_OTG_PHY_RST_CTRL		(CTL_BASE + 0x150) // 0 reset,1 exit reset
#define CTL_USB_OTG_PHY_SUSPEND			(CTL_BASE + 0x154) // 0 suspend,1 idle
...
#define APWR_BOOTCTL				(AP_PWR_BASE + (0x2E0))
#define APWR_USBCLKDIV_CTL			(AP_PWR_BASE + (0x090))
#define APWR_USBCLK_EN			(AP_PWR_BASE + (0x094))
