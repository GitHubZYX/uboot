...
LIBS += drivers/mfp/libmfp.o
LIBS += drivers/i2c/libi2c.o
#LIBS += drivers/input/libinput.o
LIBS += drivers/keypad/libkeypad.o
LIBS += drivers/nand/libnand.o
LIBS += drivers/misc/libmisc.o
LIBS += drivers/mmc/libmmc.o
LIBS += drivers/pmic/libpmic.o
...
LIBS += drivers/video/comipfb2/libvideo.o
#LIBS += drivers/watchdog/libwatchdog.o
LIBS += drivers/leds/libled.o
LIBS += common/libcommon.o
ifdef CONFIG_ENABLE_SECURE_VERIFY_FOR_BOOT
LIBS += secure_verify/librsa.o
endif
...
depend dep:	$(TIMESTAMP_FILE) $(VERSION_FILE) \
		...
		for dir in $(CPUDIR) $(dir $(LDSCRIPT)) ; do \
