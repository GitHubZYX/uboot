...
#include "memctl_inits_KMR310001M_533.h"
#define DDR_NAME "Samsung KMR310001M-B611 533M"

#elif (CONFIG_DDR_BUS_CLK == 331500000)

#include "memctl_inits_KMR310001M_332.h"
#define DDR_NAME "Samsung KMR310001M-B611 332M"

#endif

static struct memctl_data memctl_init_datas_KMR310001M[] = {
...
struct memctl_multi_ddr_struct memctl_multi_data_KMR310001M=
{
	DDR_NAME,
	0x15010052,
	0x3331314d,
	memctl_init_datas_KMR310001M,
	sizeof(memctl_init_datas_KMR310001M), //Samsung
	0x40000000,
	0x40000000,
	0x00000000,
	0x00000000,
