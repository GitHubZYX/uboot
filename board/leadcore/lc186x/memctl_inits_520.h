#ifndef __MEMCTL_INITS_520_H__
#define __MEMCTL_INITS_520_H__

// ********************************************************************
// Option: IP    : IP Mode                       = CTL
// Option: BL    : Burst Length                  = 8
// Option: CL    : CAS Latency                   = 8,4
// Option: MHZ   : Simulation MHz                = 520,260
...
#define DENALI_CTL_04_DATA 0x00000034 // TINIT_F0:RW:0:24:=0x000034
#define DENALI_CTL_05_DATA 0x000194cb // TINIT3_F0:RW:0:24:=0x0194cb
#define DENALI_CTL_06_DATA 0x00000207 // TINIT4_F0:RW:0:24:=0x000207
#define DENALI_CTL_07_DATA 0x0000143e // TINIT5_F0:RW:0:24:=0x00143e
#define DENALI_CTL_08_DATA 0x0000001a // TINIT_F1:RW:0:24:=0x00001a
#define DENALI_CTL_09_DATA 0x0000caed // TINIT3_F1:RW:0:24:=0x00caed
#define DENALI_CTL_10_DATA 0x00000104 // TINIT4_F1:RW:0:24:=0x000104
#define DENALI_CTL_11_DATA 0x01000a26 // NO_AUTO_MRR_INIT:RW:24:1:=0x01 TINIT5_F1:RW:0:24:=0x000a26
#define DENALI_CTL_12_DATA 0x00000068 // TRST_PWRON:RW:0:32:=0x00000068
#define DENALI_CTL_13_DATA 0x00000104 // CKE_INACTIVE:RW:0:32:=0x00000104
...
#define DENALI_CTL_16_DATA 0x21060202 // TRC_F0:RW:24:8:=0x21 TRRD_F0:RW:16:8:=0x06 TCCD:RW:8:5:=0x02 TBST_INT_INTERVAL:RW:0:3:=0x02
#define DENALI_CTL_17_DATA 0x1a0a0416 // TFAW_F0:RW:24:6:=0x1a TRP_F0:RW:16:5:=0x0a TWTR_F0:RW:8:6:=0x04 TRAS_MIN_F0:RW:0:8:=0x16
#define DENALI_CTL_18_DATA 0x020b1103 // TWTR_F1:RW:24:6:=0x02 TRAS_MIN_F1:RW:16:8:=0x0b TRC_F1:RW:8:8:=0x11 TRRD_F1:RW:0:8:=0x03
#define DENALI_CTL_19_DATA 0x05040d05 // TMRD_F0:RW:24:5:=0x05 TRTP_F0:RW:16:4:=0x04 TFAW_F1:RW:8:6:=0x0d TRP_F1:RW:0:5:=0x05
#define DENALI_CTL_20_DATA 0x008dad05 // TRAS_MAX_F0:RW:8:17:=0x008dad TMOD_F0:RW:0:8:=0x05
#define DENALI_CTL_21_DATA 0x05020803 // TMRD_F1:RW:24:5:=0x05 TRTP_F1:RW:16:4:=0x02 TCKESR_F0:RW:8:8:=0x08 TCKE_F0:RW:0:4:=0x03
#define DENALI_CTL_22_DATA 0x00470505 // TRAS_MAX_F1:RW:8:17:=0x004705 TMOD_F1:RW:0:8:=0x05
...
#define DENALI_CTL_28_DATA 0x00060b03 // REG_DIMM_ENABLE:RW:24:1:=0x00 TRP_AB_F1:RW:16:5:=0x06 TRP_AB_F0:RW:8:5:=0x0b BSTLEN:RW_D:0:3:=0x03
...
#define DENALI_CTL_30_DATA 0x07dc0044 // TREF_F0:RW:16:16:=0x07dc TRFC_F0:RW:0:10:=0x0044
#define DENALI_CTL_31_DATA 0x03ec0022 // TREF_F1:RW:16:16:=0x03ec TRFC_F1:RW:0:10:=0x0022
...
#define DENALI_CTL_35_DATA 0x00490000 // TXSR_F0:RW:16:16:=0x0049 TMRRI_F1:RW:8:8:=0x00 TMRRI_F0:RW:0:8:=0x00
...
#define DENALI_CTL_75_DATA 0x00020700 // ZQINIT_F0:RW_D:8:12:=0x0207 LONG_COUNT_MASK:RW:0:5:=0x00
#define DENALI_CTL_76_DATA 0x002f00bb // ZQCS_F0:RW:16:12:=0x002f ZQCL_F0:RW:0:12:=0x00bb
#define DENALI_CTL_77_DATA 0x005e0104 // ZQCL_F1:RW:16:12:=0x005e ZQINIT_F1:RW_D:0:12:=0x0104
...
#define DENALI_CTL_80_DATA 0x00001a00 // ZQRESET_F0:RW:8:12:=0x001a ZQ_IN_PROGRESS:RD:0:1:=0x00
#define DENALI_CTL_81_DATA 0x0100000d // ZQCS_ROTATE:RW:24:1:=0x01 NO_ZQ_INIT:RW:16:1:=0x00 ZQRESET_F1:RW:0:12:=0x000d
...
#define DENALI_CTL_142_DATA 0x02000040 // TDFI_PHYUPD_TYPE0_F0:RW:16:16:=0x0200 TDFI_CTRLUPD_MAX_F0:RW:0:16:=0x0fb8
#define DENALI_CTL_143_DATA 0x02000200 // TDFI_PHYUPD_TYPE2_F0:RW:16:16:=0x0200 TDFI_PHYUPD_TYPE1_F0:RW:0:16:=0x0200
#define DENALI_CTL_144_DATA 0x0fb80200 // TDFI_PHYUPD_RESP_F0:RW:16:16:=0x0fb8 TDFI_PHYUPD_TYPE3_F0:RW:0:16:=0x0200
#define DENALI_CTL_145_DATA 0x00004e98 // TDFI_CTRLUPD_INTERVAL_F0:RW:0:32:=0x00004e98
#define DENALI_CTL_146_DATA 0x00200403 // TDFI_CTRLUPD_MAX_F1:RW:16:16:=0x07d8 WRLAT_ADJ_F0:RW:8:6:=0x04 RDLAT_ADJ_F0:RW:0:6:=0x03
...
#define DENALI_CTL_149_DATA 0x000007d8 // TDFI_PHYUPD_RESP_F1:RW:0:16:=0x07d8
#define DENALI_CTL_150_DATA 0x00002738 // TDFI_CTRLUPD_INTERVAL_F1:RW:0:32:=0x00002738
...
#define DENALI_PHY_11_DATA 0x0a120039 // PHY_DLL_MASTER_CTRL_REG_F1_0:RW:0:32:=0x0a120039
...
#define DENALI_PHY_43_DATA 0x0a120039 // PHY_DLL_MASTER_CTRL_REG_F1_1:RW:0:32:=0x0a120039
...
#define DENALI_PHY_75_DATA 0x0a120039 // PHY_DLL_MASTER_CTRL_REG_F1_2:RW:0:32:=0x0a120039
...
#define DENALI_PHY_107_DATA 0x0a120039 // PHY_DLL_MASTER_CTRL_REG_F1_3:RW:0:32:=0x0a120039
...
#define DENALI_PHY_139_DATA 0x0a120039 // PHY_DLL_MASTER_CTRL_REG_F1_4:RW:0:32:=0x0a120039
