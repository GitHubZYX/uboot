...
#ifndef _LINUX_BQ24296_CHARGER_H
#define _LINUX_BQ24296_CHARGER_H
...
#define BQ24296_EN_HIZ_SHIFT          7
#define EN_HIZ                          (1)
#define DIS_HIZ                         (0)
#define BQ24296_VINDPM_SHIFT          3
...
#define BQ24296_EN_CHARGER_SHIFT    4
#define DIS_CHARGER                (0)
#define EN_CHARGER                 (1)
#define EN_CHARGER_OTG             (2)
#define BQ24296_SYS_MIN_SHIFT       1
...
#define BQ24296_IPRECHRG_SHIFT    4
...
#define BQ24296_VCHARGE_SHIFT             2
...
#define BQ24296_BOOSTV_SHIFT             4
#define BOOSTV_MIN_4550              (4550)
#define BOOSTV_4998                  (4998)
...
#define BQ24296_DPDM_EN_SHIFT                7
#define DPDM_EN                            (1)
#define DPDM_DIS                           (0)
#define TMR2X_EN                      (1 << 6)
...
#define BQ24296_VBUS_STAT_UNKNOWM        (0x00)
#define BQ24296_VBUS_STAT_USB_HOST       (0x40)
#define BQ24296_VBUS_STAT_ADATPTER       (0x80)
#define BQ24296_VBUS_STAT_OTG            (0xC0)
#define BQ24296_CHGR_STAT_NOT_CHARGING   (0x00)
#define BQ24296_CHGR_STAT_PRE_CHARGING   (0x10)
#define BQ24296_CHGR_STAT_FAST_CHARGING  (0x20)
#define BQ24296_CHGR_STAT_CHAEGE_DONE    (0x30)
#define BQ24296_NOT_DPM_STAT             (0x00)
#define BQ24296_DPM_STAT                 (0x08)
#define BQ24296_NOT_PG_STAT              (0x00)
#define BQ24296_PG_STAT                  (0x04)
#define BQ24296_THERM_STAT_NOEMAL        (0x00)
#define BQ24296_THERM_STAT_TREG          (0x02)
#define BQ24296_NOT_VSYS_STAT            (0x00)
#define BQ24296_VSYS_STAT                (0x01)
...
#define BQ24296_WATCHDOG_FAULT          (0x80)
#define BQ24296_OTG_FAULT               (0x40)
#define BQ24296_POWER_SUPPLY_OVP        (0x10)
#define BQ24296_THERMAL_SHUTDOWM        (0x20)
#define BQ24296_CHRG_TIMER_EXPIRED      (0x30)
#define BQ24296_BAT_FAULT_OVP           (0x08)
//#define BQ24296_NTC_TS1_COLD            (0x01)
//#define BQ24296_NTC_TS1_HOT             (0x02)
//#define BQ24296_NTC_TS2_COLD            (0x03)
//#define BQ24296_NTC_TS2_HOT             (0x04)
//#define BQ24296_NTC_TS1_TS2_COLD        (0x05)
//#define BQ24296_NTC_TS1_TS2_HOT         (0x06)
//#define BQ24296_NTC_TS1_TS2_HOT_COLD    (0x07)
...
#define BQ24296_WATCHDOG_TIMEOUT    (30000)
